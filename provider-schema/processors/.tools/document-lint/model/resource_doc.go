...
func (t *Timeouts) String() string {
	...
	return "Create: " + strconv.FormatInt(t.Create.Value, 10) +
		" Update: " + strconv.FormatInt(t.Update.Value, 10) +
		" Read: " + strconv.FormatInt(t.Read.Value, 10) +
		" Delete: " + strconv.FormatInt(t.Delete.Value, 10)
}
