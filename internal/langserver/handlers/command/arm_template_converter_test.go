...
func Test_Context(t *testing.T) {
	res1 := hclwrite.NewBlock("resource", []string{"azurerm_resource", "managedCluster"})
	...
	res2 := hclwrite.NewBlock("resource", []string{"azurerm_resource", "managedCluster"})
...
resource "azurerm_resource" "managedCluster1" {
  type      = "Microsoft.ContainerService/managedClusters@2021-03-01"
  name      = "myCluster"
  parent_id = "myParentId"
}
