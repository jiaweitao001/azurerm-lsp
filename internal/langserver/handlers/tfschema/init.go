...
func init() {
	...
	Resources = append(Resources,
		Resource{
			...
			Properties: []Property{
...

				{
					...
					Modifier:          "Optional",
					Type:              "list<string>",
					Description:       "A list of ARM resource IDs which are used to avoid create/modify/delete azurerm resources at the same time.",
		...
		Resource{
			Name: "resource.azurerm_update_resource",
			Properties: []Property{
				{
					Name:                "type",
					Modifier:            "Required",
		...
		Resource{
			Name: "resource.azurerm_data_plane_resource",
			Properties: []Property{
				{
					Name:              "type",
					Modifier:          "Required",
		...
		Resource{
			Name: "resource.azurerm_resource_action",
			Properties: []Property{
				{
					Name:                "type",
					Modifier:            "Required",
		...
		Resource{
			Name: "data.azurerm_resource_action",
			Properties: []Property{
				{
					Name:                "type",
					Modifier:            "Required",
		...
		Resource{
			Name: "data.azurerm_resource_list",
			Properties: []Property{
				{
					Name:                "type",
					Modifier:            "Required",
