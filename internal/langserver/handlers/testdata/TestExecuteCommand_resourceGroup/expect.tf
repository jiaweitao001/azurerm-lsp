...
terraform import azurerm_resource.resourceGroup /subscriptions/0000000/resourceGroups/app-rg5wg5lo7sa2hxrh6bs6?api-version=2024-11-01

Or add the below config:
import {
  id = "/subscriptions/0000000/resourceGroups/app-rg5wg5lo7sa2hxrh6bs6?api-version=2024-11-01"
  to = azurerm_resource.resourceGroup
}
*/
