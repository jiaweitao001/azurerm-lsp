...
terraform import azurerm_resource.managedCluster /subscriptions/0000000/resourcegroups/acctestRG-aks-240626160102776968/providers/Microsoft.ContainerService/managedClusters/acctestaks240626160102776968?api-version=2024-09-02-preview

Or add the below config:
import {
  id = "/subscriptions/0000000/resourcegroups/acctestRG-aks-240626160102776968/providers/Microsoft.ContainerService/managedClusters/acctestaks240626160102776968?api-version=2024-09-02-preview"
  to = azurerm_resource.managedCluster
}
*/

resource "azurerm_resource" "managedCluster" {
