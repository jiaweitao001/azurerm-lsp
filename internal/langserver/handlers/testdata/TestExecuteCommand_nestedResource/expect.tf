...
terraform import azurerm_resource.subnet /subscriptions/0000000/resourceGroups/acctestRG-databricks-240530173443928447/providers/Microsoft.Network/virtualNetworks/acctest-vnet-240530173443928447/subnets/acctest-sn-private-240530173443928447?api-version=2024-05-01
...
import {
  ...
  to = azurerm_resource.subnet
}
*/

resource "azurerm_resource" "subnet" {
