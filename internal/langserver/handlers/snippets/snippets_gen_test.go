...
func Test_SnippetGen(t *testing.T) {
	exampleDir := os.Getenv("azurerm_EXAMPLE_DIR")
	if exampleDir == "" {
		t.Skip("azurerm_EXAMPLE_DIR is not set")
	}
...
func Test_PlaceholderContent(t *testing.T) {
	testcases := []struct {
		...
		{
			rawContent:  "azurerm_resource.rg.output",
			addrTypeMap: map[string]string{},
			expected:    "TODO",
		},
		{
			rawContent: "data.azurerm_resource.rg.id",
			addrTypeMap: map[string]string{
				"data.azurerm_resource.rg": "Microsoft.Resources/resourceGroups@2021-04-01",
			},
			expected: "The id of the Microsoft.Resources/resourceGroups@2021-04-01 resource",
		},
		{
			rawContent: "azurerm_resource.rg.id",
			addrTypeMap: map[string]string{
				"azurerm_resource.rg": "Microsoft.Resources/resourceGroups@2021-04-01",
			},
			expected: "The id of the Microsoft.Resources/resourceGroups@2021-04-01 resource",
		},
		{
			rawContent: "data.azurerm_resource.rg.foo",
			addrTypeMap: map[string]string{
				"data.azurerm_resource.rg": "Microsoft.Resources/resourceGroups@2021-04-01",
			},
		...
		{
			rawContent: "azurerm_resource.rg.foo",
			addrTypeMap: map[string]string{
				"azurerm_resource.rg": "Microsoft.Resources/resourceGroups@2021-04-01",
			},
			expected: "The foo of the Microsoft.Resources/resourceGroups@2021-04-01 resource",
